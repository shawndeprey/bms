...
public class RenderBlocks
{
    ...
    public boolean renderBlockStainedPane(BlockStainedPane par1BlockStainedPane, int par2, int par3, int par4)
    {
        int l = this.blockAccess.getHeight();
        Tessellator tessellator = Tessellator.instance;
        tessellator.setBrightness(par1BlockStainedPane.getMixedBrightnessForBlock(this.blockAccess, par2, par3, par4));
        float f = 1.0F;
        int i1 = par1BlockStainedPane.colorMultiplier(this.blockAccess, par2, par3, par4);
        float f1 = (float)(i1 >> 16 & 255) / 255.0F;
        float f2 = (float)(i1 >> 8 & 255) / 255.0F;
        float f3 = (float)(i1 & 255) / 255.0F;
        ...
        {
            int j1 = this.blockAccess.getBlockMetadata(par2, par3, par4);
            icon = this.getBlockIconFromSideAndMetadata(par1BlockStainedPane, 0, j1);
            icon1 = par1BlockStainedPane.getSideTextureIndex();
        }
        ...
        boolean E = par1BlockStainedPane.canPaneConnectTo(this.blockAccess,par2, par3, par4, EAST);
        boolean S = par1BlockStainedPane.canPaneConnectTo(this.blockAccess,par2, par3, par4, SOUTH);
        boolean W = par1BlockStainedPane.canPaneConnectTo(this.blockAccess,par2, par3, par4, WEST);
        ...
        if((!N && !E && !S && !W) || (N && E && S && W))
        {
        	...
        	tessellator.addVertexWithUV( x,  y, z1, u16, v16);
            ...
            tessellator.addVertexWithUV(x2, y1,  z, u16, v0);
            tessellator.addVertexWithUV(x2,  y,  z, u16, v16);
        ...
        if(l >=0 && l <=3)
        {
	        if(S)
	        {
	        	if(N)
	        	{
	        		...
	        		{
	        			// Right Center
	        			return tentSideRight_0(tessellator, par2, par3, par4, icon);
	        		}
	        		else if(l == 2)
	        		{
	        			// Left Center
	        			return tentSideLeft_0(tessellator, par2, par3, par4, icon);
	        		}
	        		else if(l == 0)
	        		{
	        			// Ridge Center
	        			return tentCapCenter_0(tessellator, par2, par3, par4, icon);
	        		}
	        	}
	        	else
	        	{
	        		...
	        		{
		        		// Left Back
	        			return tentCornerLeftBack_0(tessellator, par2, par3, par4, icon);
	        		}
	        		else if(l == 2)
	        		{
	        			// Right Back
	        			return tentCornerRightBack_0(tessellator, par2, par3, par4, icon);
	        		}
	        		else if(l == 0)
	        		{
	        			// Ridge Front
	        			return tentCapFront_0(tessellator, par2, par3, par4, icon);
	        		}
	        	}
	        }
	        else if(N)
	        {
	        	...
	        	{
	        		// Left Front
	        		return tentCornerLeftFront_0(tessellator, par2, par3, par4, icon);
	        	}
	        	else if(l == 2)
	        	{
	        		// Right Front
	        		return tentCornerRightFront_0(tessellator, par2, par3, par4, icon);
	        	}
	        	else if(l == 0)
	        	{
	        		// Ridge Back
        ...
        if(l >=4 && l <=7)
        {
	        if(W)
	        {
	        	if(E)
	        	{
	        		...
	        		{
	        			// Right Center
	        			return tentSideRight_1(tessellator, par2, par3, par4, icon);
	        		}
	        		else if(l == 6)
	        		{
	        			// Left Center
	        			return tentSideLeft_1(tessellator, par2, par3, par4, icon);
	        		}
	        		else if(l == 4)
	        		{
	        			// Ridge Center
	        			return tentCapCenter_1(tessellator, par2, par3, par4, icon);
	        		}
	        	}
	        	else
	        	{
	        		...
	        		{
		        		// Right Back
	        			return tentCornerRightBack_1(tessellator, par2, par3, par4, icon);
	        		}
	        		else if(l == 6)
	        		{
	        			// Left Back
	        			return tentCornerLeftBack_1(tessellator, par2, par3, par4, icon);
	        		}
	        		else if(l == 4)
	        		{
	        			// Ridge Back
	        			return tentCapBack_1(tessellator, par2, par3, par4, icon);
	        		}
	        	}
	        }
	        else if(E)
	        {
	        	...
	        	{
	        		// Right Front
	        		return tentCornerRightFront_1(tessellator, par2, par3, par4, icon);
	        	}
	        	else if(l == 6)
	        	{
	        		// Left Front
	        		return tentCornerLeftFront_1(tessellator, par2, par3, par4, icon);
	        	}
	        	else if(l == 4)
	        	{
	        		// Ridge Front
	        		return tentCapFront_1(tessellator, par2, par3, par4, icon);
	        	}
	        }
	        if(N && S && U  && l == 7)
	        {
    ...
    // East - West
    private boolean tentSideRight_1(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0);
		double y1 = (double)(par3 + 0);
		double z1 = (double)(par4 + 1);
		double x2 = (double)(par2 + 0);
		double y2 = (double)(par3 + 0.875);
		double z2 = (double)(par4 + 0);
		double x3 = (double)(par2 + 1);
		double y3 = (double)(par3 + 0.875);
		double z3 = (double)(par4 + 0);
		double x4 = (double)(par2 + 1);
		double y4 = (double)(par3 + 0);
		double z4 = (double)(par4 + 1);
		double x5 = (double)(par2 + 0);
		double y5 = (double)(par3 + 0.125);
		double z5 = (double)(par4 + 1);
		double x6 = (double)(par2 + 0);
		double y6 = (double)(par3 + 1);
		double z6 = (double)(par4 + 0);
		double x7 = (double)(par2 + 1);
		double y7 = (double)(par3 + 1);
		double z7 = (double)(par4 + 0);
		double x8 = (double)(par2 + 1);
		double y8 = (double)(par3 + 0.125);
		double z8 = (double)(par4 + 1);
		double x9 = (double)(par2 + 0);
		double y9 = (double)(par3 + 0.4375);
		double z9 = (double)(par4 + 0.5);
		double x10 = (double)(par2 + 1);
		double y10 = (double)(par3 + 0.4375);
		double z10 = (double)(par4 + 0.5);
		double x11 = (double)(par2 + 0);
		double y11 = (double)(par3 + 0.5625);
		double z11 = (double)(par4 + 0.5);
		double x12 = (double)(par2 + 1);
		double y12 = (double)(par3 + 0.5625);
		double z12 = (double)(par4 + 0.5);

		double u1 = (double)icon.getMaxU();
		double v1 = (double)icon.getInterpolatedV(10D);
		double u2 = (double)icon.getMaxU();
		double v2 = (double)icon.getMinV();
		double u3 = (double)icon.getMinU();
		double v3 = (double)icon.getMinV();
		double u4 = (double)icon.getMinU();
		double v4 = (double)icon.getInterpolatedV(10D);
		double u5 = (double)icon.getInterpolatedU(8D);
		double v5 = (double)icon.getInterpolatedV(9D);
		double u6 = (double)icon.getInterpolatedU(8D);
		double v6 = (double)icon.getInterpolatedV(7D);
		double u7 = (double)icon.getMinU();
		double v7 = (double)icon.getInterpolatedV(2D);
		double u8 = (double)icon.getMaxU();
		double v8 = (double)icon.getInterpolatedV(2D);
		double u9 = (double)icon.getMinU();
		double v9 = (double)icon.getInterpolatedV(14D);
		double u10 = (double)icon.getMinU();
		double v10 = (double)icon.getMaxV();
		double u11 = (double)icon.getMaxU();
		double v11 = (double)icon.getMaxV();
		double u12 = (double)icon.getMaxU();
		double v12 = (double)icon.getInterpolatedV(6D);
		double u13 = (double)icon.getMinU();
		double v13 = (double)icon.getInterpolatedV(6D);
		double u14 = (double)icon.getMaxU();
		double v14 = (double)icon.getInterpolatedV(14D);
		
		tessellator.addVertexWithUV(x9, y9, z9, u1, v1);
		...
		tessellator.addVertexWithUV(x11, y11, z11, u4, v4);
		tessellator.addVertexWithUV(x12, y12, z12, u1, v1);
		tessellator.addVertexWithUV(x7, y7, z7, u2, v2);
		tessellator.addVertexWithUV(x6, y6, z6, u3, v3);
		tessellator.addVertexWithUV(x9, y9, z9, u5, v5);
		tessellator.addVertexWithUV(x11, y11, z11, u6, v6);
		tessellator.addVertexWithUV(x6, y6, z6, u3, v3);
		tessellator.addVertexWithUV(x2, y2, z2, u7, v7);
		tessellator.addVertexWithUV(x2, y2, z2, u8, v8);
		tessellator.addVertexWithUV(x6, y6, z6, u2, v2);
		tessellator.addVertexWithUV(x7, y7, z7, u3, v3);
		tessellator.addVertexWithUV(x3, y3, z3, u7, v7);
		tessellator.addVertexWithUV(x10, y10, z10, u5, v5);
		tessellator.addVertexWithUV(x12, y12, z12, u6, v6);
		tessellator.addVertexWithUV(x8, y8, z8, u9, v9);
		tessellator.addVertexWithUV(x4, y4, z4, u10, v10);
		tessellator.addVertexWithUV(x5, y5, z5, u3, v3);
		tessellator.addVertexWithUV(x1, y1, z1, u7, v7);
		tessellator.addVertexWithUV(x4, y4, z4, u8, v8);
		tessellator.addVertexWithUV(x8, y8, z8, u2, v2);
		tessellator.addVertexWithUV(x1, y1, z1, u11, v11);
		tessellator.addVertexWithUV(x9, y9, z9, u12, v12);
		tessellator.addVertexWithUV(x10, y10, z10, u13, v13);
		tessellator.addVertexWithUV(x4, y4, z4, u10, v10);
		tessellator.addVertexWithUV(x5, y5, z5, u10, v10);
		tessellator.addVertexWithUV(x8, y8, z8, u11, v11);
		tessellator.addVertexWithUV(x12, y12, z12, u12, v12);
		tessellator.addVertexWithUV(x11, y11, z11, u13, v13);
		tessellator.addVertexWithUV(x1, y1, z1, u11, v11);
		tessellator.addVertexWithUV(x5, y5, z5, u14, v14);
		tessellator.addVertexWithUV(x11, y11, z11, u6, v6);
		tessellator.addVertexWithUV(x9, y9, z9, u5, v5);
		tessellator.addVertexWithUV(x3, y3, z3, u8, v8);
		tessellator.addVertexWithUV(x7, y7, z7, u2, v2);
		tessellator.addVertexWithUV(x12, y12, z12, u6, v6);
		tessellator.addVertexWithUV(x10, y10, z10, u5, v5);
    	return true;
    ...
    private boolean tentSideLeft_1(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 1);
		double y1 = (double)(par3 + 0);
		double z1 = (double)(par4 + 0);
		double x2 = (double)(par2 + 1);
		double y2 = (double)(par3 + 0.875);
		...
		double y4 = (double)(par3 + 0);
		double z4 = (double)(par4 + 0);
		double x5 = (double)(par2 + 1);
		double y5 = (double)(par3 + 0.125);
		double z5 = (double)(par4 + 0);
		double x6 = (double)(par2 + 1);
		double y6 = (double)(par3 + 1);
		...
		double y8 = (double)(par3 + 0.125);
		double z8 = (double)(par4 + 0);
		double x9 = (double)(par2 + 1);
		double y9 = (double)(par3 + 0.4375);
		double z9 = (double)(par4 + 0.5);
		double x10 = (double)(par2 + 0);
		double y10 = (double)(par3 + 0.4375);
		double z10 = (double)(par4 + 0.5);
		double x11 = (double)(par2 + 1);
		double y11 = (double)(par3 + 0.5625);
		double z11 = (double)(par4 + 0.5);
    ...
    private boolean tentWall_1(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0.5625);
    	double y1 = (double)(par3 + 0);
    	double z1 = (double)(par4 + 1);
    	double x2 = (double)(par2 + 0.4375);
    	double y2 = (double)(par3 + 0);
    	double z2 = (double)(par4 + 1);
    	double x3 = (double)(par2 + 0.4375);
    	double y3 = (double)(par3 + 0);
    	double z3 = (double)(par4 + 0);
    	double x4 = (double)(par2 + 0.5625);
    	double y4 = (double)(par3 + 0);
    	double z4 = (double)(par4 + 0);
    	double x5 = (double)(par2 + 0.5625);
    	double y5 = (double)(par3 + 1);
    	double z5 = (double)(par4 + 1);
    	double x6 = (double)(par2 + 0.4375);
    	double y6 = (double)(par3 + 1);
    	double z6 = (double)(par4 + 1);
    	double x7 = (double)(par2 + 0.4375);
    	double y7 = (double)(par3 + 1);
    	double z7 = (double)(par4 + 0);
    	double x8 = (double)(par2 + 0.5625);
    	double y8 = (double)(par3 + 1);
    	double z8 = (double)(par4 + 0);

    	double u1 = (double)icon.getMaxU();
    	double v1 = (double)icon.getInterpolatedV(9D);
    	double u2 = (double)icon.getMaxU();
    	double v2 = (double)icon.getInterpolatedV(7D);
    	double u3 = (double)icon.getMinU();
    	double v3 = (double)icon.getInterpolatedV(7D);
    	double u4 = (double)icon.getMinU();
    	double v4 = (double)icon.getInterpolatedV(9D);
    	double u5 = (double)icon.getInterpolatedU(9D);
    	double v5 = (double)icon.getMaxV();
    	double u6 = (double)icon.getInterpolatedU(9D);
    	double v6 = (double)icon.getMinV();
    	double u7 = (double)icon.getInterpolatedU(7D);
    	double v7 = (double)icon.getMinV();
    	double u8 = (double)icon.getInterpolatedU(7D);
    	double v8 = (double)icon.getMaxV();
    	double u9 = (double)icon.getMaxU();
    	double v9 = (double)icon.getMaxV();
    	double u10 = (double)icon.getMaxU();
    	double v10 = (double)icon.getMinV();
    	double u11 = (double)icon.getMinU();
    	double v11 = (double)icon.getMinV();
    	double u12 = (double)icon.getMinU();
    	...
    	tessellator.addVertexWithUV(x5, y5, z5, u2, v2);
    	tessellator.addVertexWithUV(x8, y8, z8, u3, v3);
    	tessellator.addVertexWithUV(x7, y7, z7, u4, v4);
    	tessellator.addVertexWithUV(x6, y6, z6, u1, v1);
    	tessellator.addVertexWithUV(x1, y1, z1, u5, v5);
    	tessellator.addVertexWithUV(x5, y5, z5, u6, v6);
    	tessellator.addVertexWithUV(x6, y6, z6, u7, v7);
    	tessellator.addVertexWithUV(x2, y2, z2, u8, v8);
    	tessellator.addVertexWithUV(x2, y2, z2, u9, v9);
    	tessellator.addVertexWithUV(x6, y6, z6, u10, v10);
    	tessellator.addVertexWithUV(x7, y7, z7, u11, v11);
    	tessellator.addVertexWithUV(x3, y3, z3, u12, v12);
    	tessellator.addVertexWithUV(x3, y3, z3, u5, v5);
    	tessellator.addVertexWithUV(x7, y7, z7, u6, v6);
    	tessellator.addVertexWithUV(x8, y8, z8, u7, v7);
    	tessellator.addVertexWithUV(x4, y4, z4, u8, v8);
    	tessellator.addVertexWithUV(x5, y5, z5, u11, v11);
    	tessellator.addVertexWithUV(x1, y1, z1, u12, v12);
    	tessellator.addVertexWithUV(x4, y4, z4, u9, v9);
    	tessellator.addVertexWithUV(x8, y8, z8, u10, v10);
    	return true;
    }
    
    private boolean tentCornerRightFront_1(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 1);
		double y1 = (double)(par3 + 0);
		double z1 = (double)(par4 + 1);
		...
		double z9 = (double)(par4 + 0.5);
		double x10 = (double)(par2 + 1);
		double y10 = (double)(par3 + 0.5625);
		double z10 = (double)(par4 + 0.5);
		double x11 = (double)(par2 + 0.4375);
		double y11 = (double)(par3 + 0.5625);
		double z11 = (double)(par4 + 0.5);
		double x12 = (double)(par2 + 0.5625);
		double y12 = (double)(par3 + 0);
		double z12 = (double)(par4 + 1);
		double x13 = (double)(par2 + 0.5625);
		double y13 = (double)(par3 + 0.125);
		double z13 = (double)(par4 + 1);
		double x14 = (double)(par2 + 0.5625);
		double y14 = (double)(par3 + 1);
		double z14 = (double)(par4 + 0);
		double x15 = (double)(par2 + 0.5625);
		double y15 = (double)(par3 + 0.4375);
		double z15 = (double)(par4 + 0.5);
		double x16 = (double)(par2 + 0.5625);
		double y16 = (double)(par3 + 0);
		double z16 = (double)(par4 + 0);
		double x17 = (double)(par2 + 0.5625);
		double y17 = (double)(par3 + 0.875);
		double z17 = (double)(par4 + 0);

		double u1 = (double)icon.getInterpolatedU(8D);
		double v1 = (double)icon.getInterpolatedV(9D);
		double u2 = (double)icon.getMaxU();
		double v2 = (double)icon.getInterpolatedV(2D);
		double u3 = (double)icon.getMaxU();
		double v3 = (double)icon.getMinV();
		double u4 = (double)icon.getInterpolatedU(8D);
		double v4 = (double)icon.getInterpolatedV(7D);
		double u5 = (double)icon.getInterpolatedU(9D);
		double v5 = (double)icon.getMinV();
		double u6 = (double)icon.getInterpolatedU(7D);
		double v6 = (double)icon.getMinV();
		double u7 = (double)icon.getInterpolatedU(7D);
		double v7 = (double)icon.getInterpolatedV(2D);
		double u8 = (double)icon.getInterpolatedU(9D);
		double v8 = (double)icon.getInterpolatedV(2D);
		double u9 = (double)icon.getMinU();
		double v9 = (double)icon.getMaxV();
		double u10 = (double)icon.getMaxU();
		double v10 = (double)icon.getMaxV();
		double u11 = (double)icon.getMinU();
		double v11 = (double)icon.getInterpolatedV(14D);
		double u12 = (double)icon.getMaxU();
		double v12 = (double)icon.getInterpolatedV(14D);
		double u13 = (double)icon.getMinU();
		double v13 = (double)icon.getMinV();
		double u14 = (double)icon.getMaxU();
		double v14 = (double)icon.getInterpolatedV(10D);
		double u15 = (double)icon.getInterpolatedU(7D);
		double v15 = (double)icon.getInterpolatedV(10D);
		double u16 = (double)icon.getInterpolatedU(7D);
		double v16 = (double)icon.getMaxV();
		double u17 = (double)icon.getInterpolatedU(7D);
		double v17 = (double)icon.getInterpolatedV(6D);
		double u18 = (double)icon.getMinU();
		double v18 = (double)icon.getInterpolatedV(6D);
		double u19 = (double)icon.getMaxU();
		double v19 = (double)icon.getInterpolatedV(6D);
		double u20 = (double)icon.getMinU();
		double v20 = (double)icon.getInterpolatedV(10D);
		double u21 = (double)icon.getMinU();
		double v21 = (double)icon.getInterpolatedV(2D);
		double u22 = (double)icon.getInterpolatedU(9D);
		double v22 = (double)icon.getMaxV();
		double u23 = (double)icon.getMaxU();
		double v23 = (double)icon.getInterpolatedV(9D);
		double u24 = (double)icon.getMaxU();
		double v24 = (double)icon.getInterpolatedV(7D);
		double u25 = (double)icon.getMinU();
		double v25 = (double)icon.getInterpolatedV(7D);
		double u26 = (double)icon.getMinU();
		double v26 = (double)icon.getInterpolatedV(9D);

		tessellator.addVertexWithUV(x9, y9, z9, u1, v1);
		tessellator.addVertexWithUV(x2, y2, z2, u2, v2);
		tessellator.addVertexWithUV(x6, y6, z6, u3, v3);
		tessellator.addVertexWithUV(x10, y10, z10, u4, v4);
		tessellator.addVertexWithUV(x13, y13, z13, u5, v5);
		tessellator.addVertexWithUV(x8, y8, z8, u6, v6);
		tessellator.addVertexWithUV(x4, y4, z4, u7, v7);
		tessellator.addVertexWithUV(x12, y12, z12, u8, v8);
		tessellator.addVertexWithUV(x15, y15, z15, u1, v1);
		tessellator.addVertexWithUV(x12, y12, z12, u9, v9);
		tessellator.addVertexWithUV(x16, y16, z16, u10, v10);
		tessellator.addVertexWithUV(x17, y17, z17, u2, v2);
		tessellator.addVertexWithUV(x1, y1, z1, u9, v9);
		tessellator.addVertexWithUV(x9, y9, z9, u1, v1);
		tessellator.addVertexWithUV(x10, y10, z10, u4, v4);
		tessellator.addVertexWithUV(x5, y5, z5, u11, v11);
		tessellator.addVertexWithUV(x4, y4, z4, u10, v10);
		tessellator.addVertexWithUV(x8, y8, z8, u12, v12);
		tessellator.addVertexWithUV(x7, y7, z7, u13, v13);
		tessellator.addVertexWithUV(x3, y3, z3, u9, v9);
		tessellator.addVertexWithUV(x10, y10, z10, u14, v14);
		tessellator.addVertexWithUV(x6, y6, z6, u3, v3);
		tessellator.addVertexWithUV(x7, y7, z7, u6, v6);
		tessellator.addVertexWithUV(x11, y11, z11, u15, v15);
		tessellator.addVertexWithUV(x12, y12, z12, u8, v8);
		tessellator.addVertexWithUV(x1, y1, z1, u2, v2);
		tessellator.addVertexWithUV(x5, y5, z5, u3, v3);
		tessellator.addVertexWithUV(x13, y13, z13, u5, v5);
		tessellator.addVertexWithUV(x1, y1, z1, u9, v9);
		tessellator.addVertexWithUV(x12, y12, z12, u16, v16);
		tessellator.addVertexWithUV(x15, y15, z15, u17, v17);
		tessellator.addVertexWithUV(x9, y9, z9, u18, v18);
		tessellator.addVertexWithUV(x11, y11, z11, u17, v17);
		tessellator.addVertexWithUV(x8, y8, z8, u16, v16);
		tessellator.addVertexWithUV(x5, y5, z5, u10, v10);
		tessellator.addVertexWithUV(x10, y10, z10, u19, v19);
		tessellator.addVertexWithUV(x15, y15, z15, u15, v15);
		tessellator.addVertexWithUV(x17, y17, z17, u6, v6);
		tessellator.addVertexWithUV(x2, y2, z2, u13, v13);
		tessellator.addVertexWithUV(x9, y9, z9, u20, v20);
		tessellator.addVertexWithUV(x17, y17, z17, u7, v7);
		tessellator.addVertexWithUV(x14, y14, z14, u6, v6);
		tessellator.addVertexWithUV(x6, y6, z6, u13, v13);
		tessellator.addVertexWithUV(x2, y2, z2, u21, v21);
		tessellator.addVertexWithUV(x16, y16, z16, u16, v16);
		tessellator.addVertexWithUV(x3, y3, z3, u22, v22);
		tessellator.addVertexWithUV(x7, y7, z7, u5, v5);
		tessellator.addVertexWithUV(x14, y14, z14, u6, v6);
		tessellator.addVertexWithUV(x12, y12, z12, u23, v23);
		tessellator.addVertexWithUV(x4, y4, z4, u24, v24);
		tessellator.addVertexWithUV(x3, y3, z3, u25, v25);
		tessellator.addVertexWithUV(x16, y16, z16, u26, v26);
    	return true;
    }

    private boolean tentCornerRightBack_1(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0);
		double y1 = (double)(par3 + 0);
		double z1 = (double)(par4 + 1);
		...
		double y10 = (double)(par3 + 0.5625);
		double z10 = (double)(par4 + 0.5);
		double x11 = (double)(par2 + 0.5625);
		double y11 = (double)(par3 + 0.5625);
		double z11 = (double)(par4 + 0.5);
		double x12 = (double)(par2 + 0.4375);
		double y12 = (double)(par3 + 0);
		double z12 = (double)(par4 + 1);
		double x13 = (double)(par2 + 0.4375);
		double y13 = (double)(par3 + 0.125);
		double z13 = (double)(par4 + 1);
		double x14 = (double)(par2 + 0.4375);
		double y14 = (double)(par3 + 1);
		double z14 = (double)(par4 + 0);
		double x15 = (double)(par2 + 0.4375);
		double y15 = (double)(par3 + 0.4375);
		double z15 = (double)(par4 + 0.5);
		double x16 = (double)(par2 + 0.4375);
		double y16 = (double)(par3 + 0);
		double z16 = (double)(par4 + 0);
		double x17 = (double)(par2 + 0.4375);
		double y17 = (double)(par3 + 0.875);
		double z17 = (double)(par4 + 0);

		double u1 = (double)icon.getInterpolatedU(8D);
		double v1 = (double)icon.getInterpolatedV(9D);
		double u2 = (double)icon.getInterpolatedU(8D);
		double v2 = (double)icon.getInterpolatedV(7D);
		double u3 = (double)icon.getMinU();
		double v3 = (double)icon.getMinV();
		double u4 = (double)icon.getMinU();
		double v4 = (double)icon.getInterpolatedV(2D);
		double u5 = (double)icon.getInterpolatedU(7D);
		double v5 = (double)icon.getMinV();
		double u6 = (double)icon.getInterpolatedU(7D);
		double v6 = (double)icon.getInterpolatedV(2D);
		double u7 = (double)icon.getInterpolatedU(9D);
		double v7 = (double)icon.getInterpolatedV(2D);
		double u8 = (double)icon.getInterpolatedU(9D);
		...
		double v11 = (double)icon.getInterpolatedV(14D);
		double u12 = (double)icon.getMaxU();
		double v12 = (double)icon.getMinV();
		double u13 = (double)icon.getMinU();
		double v13 = (double)icon.getInterpolatedV(14D);
		double u14 = (double)icon.getMinU();
		double v14 = (double)icon.getInterpolatedV(10D);
		double u15 = (double)icon.getInterpolatedU(9D);
		double v15 = (double)icon.getInterpolatedV(10D);
		double u16 = (double)icon.getMaxU();
		double v16 = (double)icon.getInterpolatedV(6D);
		double u17 = (double)icon.getInterpolatedU(9D);
		double v17 = (double)icon.getInterpolatedV(6D);
		double u18 = (double)icon.getInterpolatedU(9D);
		double v18 = (double)icon.getMaxV();
		double u19 = (double)icon.getMinU();
		double v19 = (double)icon.getInterpolatedV(6D);
		double u20 = (double)icon.getMaxU();
		double v20 = (double)icon.getInterpolatedV(10D);
		double u21 = (double)icon.getMaxU();
		double v21 = (double)icon.getInterpolatedV(2D);
		double u22 = (double)icon.getInterpolatedU(7D);
		double v22 = (double)icon.getMaxV();
		double u23 = (double)icon.getMinU();
		double v23 = (double)icon.getInterpolatedV(9D);
		double u24 = (double)icon.getMaxU();
		double v24 = (double)icon.getInterpolatedV(9D);
		double u25 = (double)icon.getMaxU();
		double v25 = (double)icon.getInterpolatedV(7D);
		double u26 = (double)icon.getMinU();
		double v26 = (double)icon.getInterpolatedV(7D);

		tessellator.addVertexWithUV(x9, y9, z9, u1, v1);
		tessellator.addVertexWithUV(x10, y10, z10, u2, v2);
		tessellator.addVertexWithUV(x6, y6, z6, u3, v3);
		tessellator.addVertexWithUV(x2, y2, z2, u4, v4);
		tessellator.addVertexWithUV(x13, y13, z13, u5, v5);
		tessellator.addVertexWithUV(x12, y12, z12, u6, v6);
		tessellator.addVertexWithUV(x4, y4, z4, u7, v7);
		tessellator.addVertexWithUV(x8, y8, z8, u8, v8);
		tessellator.addVertexWithUV(x15, y15, z15, u1, v1);
		tessellator.addVertexWithUV(x17, y17, z17, u4, v4);
		tessellator.addVertexWithUV(x16, y16, z16, u9, v9);
		tessellator.addVertexWithUV(x12, y12, z12, u10, v10);
		tessellator.addVertexWithUV(x1, y1, z1, u10, v10);
		tessellator.addVertexWithUV(x5, y5, z5, u11, v11);
		tessellator.addVertexWithUV(x10, y10, z10, u2, v2);
		tessellator.addVertexWithUV(x9, y9, z9, u1, v1);
		tessellator.addVertexWithUV(x4, y4, z4, u9, v9);
		tessellator.addVertexWithUV(x3, y3, z3, u10, v10);
		tessellator.addVertexWithUV(x7, y7, z7, u12, v12);
		tessellator.addVertexWithUV(x8, y8, z8, u13, v13);
		tessellator.addVertexWithUV(x10, y10, z10, u14, v14);
		tessellator.addVertexWithUV(x11, y11, z11, u15, v15);
		tessellator.addVertexWithUV(x7, y7, z7, u8, v8);
		tessellator.addVertexWithUV(x6, y6, z6, u3, v3);
		tessellator.addVertexWithUV(x5, y5, z5, u3, v3);
		...
		tessellator.addVertexWithUV(x13, y13, z13, u5, v5);
		tessellator.addVertexWithUV(x1, y1, z1, u10, v10);
		tessellator.addVertexWithUV(x9, y9, z9, u16, v16);
		tessellator.addVertexWithUV(x15, y15, z15, u17, v17);
		tessellator.addVertexWithUV(x12, y12, z12, u18, v18);
		tessellator.addVertexWithUV(x11, y11, z11, u17, v17);
		tessellator.addVertexWithUV(x10, y10, z10, u19, v19);
		tessellator.addVertexWithUV(x5, y5, z5, u9, v9);
		tessellator.addVertexWithUV(x8, y8, z8, u18, v18);
		tessellator.addVertexWithUV(x15, y15, z15, u15, v15);
		tessellator.addVertexWithUV(x9, y9, z9, u20, v20);
		tessellator.addVertexWithUV(x2, y2, z2, u12, v12);
		tessellator.addVertexWithUV(x17, y17, z17, u8, v8);
		tessellator.addVertexWithUV(x17, y17, z17, u7, v7);
		tessellator.addVertexWithUV(x2, y2, z2, u21, v21);
		tessellator.addVertexWithUV(x6, y6, z6, u12, v12);
		tessellator.addVertexWithUV(x14, y14, z14, u8, v8);
		tessellator.addVertexWithUV(x16, y16, z16, u18, v18);
		tessellator.addVertexWithUV(x14, y14, z14, u8, v8);
		tessellator.addVertexWithUV(x7, y7, z7, u5, v5);
		tessellator.addVertexWithUV(x3, y3, z3, u22, v22);
		tessellator.addVertexWithUV(x12, y12, z12, u23, v23);
		tessellator.addVertexWithUV(x16, y16, z16, u24, v24);
		tessellator.addVertexWithUV(x3, y3, z3, u25, v25);
		tessellator.addVertexWithUV(x4, y4, z4, u26, v26);
    	return true;
    }

    private boolean tentCornerLeftFront_1(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 1);
		double y1 = (double)(par3 + 0);
		double z1 = (double)(par4 + 0);
		...
		double x12 = (double)(par2 + 0.5625);
		double y12 = (double)(par3 + 0);
		double z12 = (double)(par4 + 0);
		double x13 = (double)(par2 + 0.5625);
		double y13 = (double)(par3 + 0.125);
		double z13 = (double)(par4 + 0);
		double x14 = (double)(par2 + 0.5625);
		double y14 = (double)(par3 + 1);
		double z14 = (double)(par4 + 1);
		double x15 = (double)(par2 + 0.5625);
		double y15 = (double)(par3 + 0.4375);
		double z15 = (double)(par4 + 0.5);
		double x16 = (double)(par2 + 0.5625);
		double y16 = (double)(par3 + 0);
		double z16 = (double)(par4 + 1);
		double x17 = (double)(par2 + 0.5625);
		double y17 = (double)(par3 + 0.875);
		double z17 = (double)(par4 + 1);
    ...
    private boolean tentCornerLeftBack_1(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0);
		double y1 = (double)(par3 + 0);
		double z1 = (double)(par4 + 0);
    ...
    private boolean tentCapFront_1(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0.4375);
		double y1 = (double)(par3 + 0);
		double z1 = (double)(par4 + 1);
		double x2 = (double)(par2 + 0.4375);
		double y2 = (double)(par3 + 0);
		...
		double y4 = (double)(par3 + 0);
		double z4 = (double)(par4 + 1);
		double x5 = (double)(par2 + 0.4375);
		double y5 = (double)(par3 + 0.125);
		double z5 = (double)(par4 + 1);
		double x6 = (double)(par2 + 0.4375);
		double y6 = (double)(par3 + 0.125);
		double z6 = (double)(par4 + 0);
		double x7 = (double)(par2 + 1);
		double y7 = (double)(par3 + 0.125);
		double z7 = (double)(par4 + 0);
		double x8 = (double)(par2 + 1);
		double y8 = (double)(par3 + 0.125);
		double z8 = (double)(par4 + 1);
		double x9 = (double)(par2 + 0.4375);
		double y9 = (double)(par3 + 0);
		double z9 = (double)(par4 + 0.5);
		double x10 = (double)(par2 + 1);
		double y10 = (double)(par3 + 0.4375);
		double z10 = (double)(par4 + 0.5);
		...
		double z12 = (double)(par4 + 0.5);
		double x13 = (double)(par2 + 0.5625);
		double y13 = (double)(par3 + 0);
		double z13 = (double)(par4 + 0.5);
		double x14 = (double)(par2 + 0.5625);
		double y14 = (double)(par3 + 0);
		double z14 = (double)(par4 + 1);
		double x15 = (double)(par2 + 0.5625);
		double y15 = (double)(par3 + 0);
		double z15 = (double)(par4 + 0);
		double x16 = (double)(par2 + 0.5625);
		double y16 = (double)(par3 + 0.4375);
		double z16 = (double)(par4 + 0.5);

		double u1 = (double)icon.getInterpolatedU(14D);
		double v1 = (double)icon.getInterpolatedV(10D);
		double u2 = (double)icon.getMinU();
		double v2 = (double)icon.getMaxV();
		double u3 = (double)icon.getMinU();
		double v3 = (double)icon.getMinV();
		double u4 = (double)icon.getInterpolatedU(9D);
		double v4 = (double)icon.getMinV();
		double u5 = (double)icon.getMinU();
		double v5 = (double)icon.getInterpolatedV(10D);
		double u6 = (double)icon.getInterpolatedU(9D);
		double v6 = (double)icon.getInterpolatedV(10D);
		double u7 = (double)icon.getInterpolatedU(8D);
		double v7 = (double)icon.getMaxV();
		double u8 = (double)icon.getInterpolatedU(8D);
		double v8 = (double)icon.getInterpolatedV(7D);
		double u9 = (double)icon.getMinU();
		double v9 = (double)icon.getInterpolatedV(14D);
		double u10 = (double)icon.getInterpolatedU(9D);
		double v10 = (double)icon.getInterpolatedV(2D);
		double u11 = (double)icon.getMinU();
		double v11 = (double)icon.getInterpolatedV(2D);
		double u12 = (double)icon.getInterpolatedU(8D);
		double v12 = (double)icon.getInterpolatedV(9D);
		double u13 = (double)icon.getInterpolatedU(7D);
		double v13 = (double)icon.getMinV();
		double u14 = (double)icon.getInterpolatedU(7D);
		double v14 = (double)icon.getInterpolatedV(2D);
		double u15 = (double)icon.getMaxU();
		double v15 = (double)icon.getInterpolatedV(2D);
		double u16 = (double)icon.getMaxU();
		double v16 = (double)icon.getMinV();
		double u17 = (double)icon.getInterpolatedU(7D);
		double v17 = (double)icon.getInterpolatedV(10D);
		double u18 = (double)icon.getMaxU();
		double v18 = (double)icon.getInterpolatedV(10D);
		double u19 = (double)icon.getMaxU();
		double v19 = (double)icon.getMaxV();
		double u20 = (double)icon.getMaxU();
		double v20 = (double)icon.getInterpolatedV(14D);

		tessellator.addVertexWithUV(x13, y13, z13, u1, v1);
		tessellator.addVertexWithUV(x9, y9, z9, u2, v2);
		tessellator.addVertexWithUV(x2, y2, z2, u3, v3);
		tessellator.addVertexWithUV(x15, y15, z15, u3, v3);
		tessellator.addVertexWithUV(x11, y11, z11, u4, v4);
		tessellator.addVertexWithUV(x12, y12, z12, u3, v3);
		tessellator.addVertexWithUV(x7, y7, z7, u5, v5);
		tessellator.addVertexWithUV(x6, y6, z6, u6, v6);
		tessellator.addVertexWithUV(x9, y9, z9, u7, v7);
		tessellator.addVertexWithUV(x11, y11, z11, u8, v8);
		tessellator.addVertexWithUV(x6, y6, z6, u9, v9);
		tessellator.addVertexWithUV(x2, y2, z2, u2, v2);
		tessellator.addVertexWithUV(x2, y2, z2, u10, v10);
		tessellator.addVertexWithUV(x6, y6, z6, u4, v4);
		tessellator.addVertexWithUV(x7, y7, z7, u3, v3);
		tessellator.addVertexWithUV(x3, y3, z3, u11, v11);
		tessellator.addVertexWithUV(x10, y10, z10, u12, v12);
		tessellator.addVertexWithUV(x12, y12, z12, u8, v8);
		tessellator.addVertexWithUV(x8, y8, z8, u9, v9);
		tessellator.addVertexWithUV(x4, y4, z4, u2, v2);
		tessellator.addVertexWithUV(x5, y5, z5, u13, v13);
		tessellator.addVertexWithUV(x1, y1, z1, u14, v14);
		tessellator.addVertexWithUV(x4, y4, z4, u15, v15);
		tessellator.addVertexWithUV(x8, y8, z8, u16, v16);
		tessellator.addVertexWithUV(x5, y5, z5, u17, v17);
		tessellator.addVertexWithUV(x8, y8, z8, u18, v18);
		tessellator.addVertexWithUV(x12, y12, z12, u16, v16);
		tessellator.addVertexWithUV(x11, y11, z11, u13, v13);
		tessellator.addVertexWithUV(x1, y1, z1, u19, v19);
		tessellator.addVertexWithUV(x5, y5, z5, u20, v20);
		tessellator.addVertexWithUV(x11, y11, z11, u8, v8);
		tessellator.addVertexWithUV(x9, y9, z9, u7, v7);
		tessellator.addVertexWithUV(x3, y3, z3, u19, v19);
		tessellator.addVertexWithUV(x7, y7, z7, u20, v20);
		tessellator.addVertexWithUV(x12, y12, z12, u8, v8);
		tessellator.addVertexWithUV(x10, y10, z10, u12, v12);
		tessellator.addVertexWithUV(x14, y14, z14, u3, v3);
		tessellator.addVertexWithUV(x1, y1, z1, u12, v12);
		tessellator.addVertexWithUV(x9, y9, z9, u1, v1);
		tessellator.addVertexWithUV(x13, y13, z13, u3, v3);
		tessellator.addVertexWithUV(x14, y14, z14, u2, v2);
		tessellator.addVertexWithUV(x13, y13, z13, u7, v7);
		tessellator.addVertexWithUV(x15, y15, z15, u19, v19);
		tessellator.addVertexWithUV(x16, y16, z16, u8, v8);
		tessellator.addVertexWithUV(x16, y16, z16, u13, v13);
		tessellator.addVertexWithUV(x10, y10, z10, u3, v3);
		tessellator.addVertexWithUV(x4, y4, z4, u5, v5);
		tessellator.addVertexWithUV(x14, y14, z14, u17, v17);
		tessellator.addVertexWithUV(x10, y10, z10, u4, v4);
		tessellator.addVertexWithUV(x16, y16, z16, u3, v3);
		tessellator.addVertexWithUV(x15, y15, z15, u5, v5);
		tessellator.addVertexWithUV(x3, y3, z3, u6, v6);
    	return true;
    }
    
    private boolean tentCapCenter_1(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0);
		double y1 = (double)(par3 + 0);
		double z1 = (double)(par4 + 1);
		...
		double v6 = (double)icon.getInterpolatedV(7D);
		double u7 = (double)icon.getMinU();
		double v7 = (double)icon.getInterpolatedV(14D);
		double u8 = (double)icon.getMinU();
		double v8 = (double)icon.getMaxV();
		double u9 = (double)icon.getMaxU();
		double v9 = (double)icon.getInterpolatedV(2D);
		double u10 = (double)icon.getMinU();
		double v10 = (double)icon.getInterpolatedV(2D);
		double u11 = (double)icon.getMaxU();
		double v11 = (double)icon.getMaxV();
		...
		tessellator.addVertexWithUV(x3, y3, z3, u3, v3);
		tessellator.addVertexWithUV(x10, y10, z10, u4, v4);
		tessellator.addVertexWithUV(x11, y11, z11, u2, v2);
		tessellator.addVertexWithUV(x12, y12, z12, u3, v3);
		tessellator.addVertexWithUV(x7, y7, z7, u4, v4);
		tessellator.addVertexWithUV(x6, y6, z6, u1, v1);
		tessellator.addVertexWithUV(x9, y9, z9, u5, v5);
		...
		tessellator.addVertexWithUV(x10, y10, z10, u13, v13);
		tessellator.addVertexWithUV(x4, y4, z4, u8, v8);
		tessellator.addVertexWithUV(x5, y5, z5, u4, v4);
		tessellator.addVertexWithUV(x8, y8, z8, u1, v1);
		tessellator.addVertexWithUV(x12, y12, z12, u2, v2);
		tessellator.addVertexWithUV(x11, y11, z11, u3, v3);
		tessellator.addVertexWithUV(x1, y1, z1, u11, v11);
		tessellator.addVertexWithUV(x5, y5, z5, u14, v14);
		tessellator.addVertexWithUV(x11, y11, z11, u6, v6);
		tessellator.addVertexWithUV(x9, y9, z9, u5, v5);
		tessellator.addVertexWithUV(x3, y3, z3, u11, v11);
		tessellator.addVertexWithUV(x7, y7, z7, u14, v14);
		tessellator.addVertexWithUV(x12, y12, z12, u6, v6);
		tessellator.addVertexWithUV(x10, y10, z10, u5, v5);
    	return true;
    }
    
    private boolean tentCapBack_1(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0.5625);
		double y1 = (double)(par3 + 0);
		double z1 = (double)(par4 + 0);
		double x2 = (double)(par2 + 0.5625);
		double y2 = (double)(par3 + 0);
		double z2 = (double)(par4 + 1);
		double x3 = (double)(par2 + 0);
		double y3 = (double)(par3 + 0);
    ...
    // North - South
    private boolean tentSideRight_0(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 1);
    	double y1 = (double)(par3 + 0);
    	double z1 = (double)(par4 + 1);
    	...
    	double y8 = (double)(par3 + 0.125);
    	double z8 = (double)(par4 + 0);
    	double x9 = (double)(par2 + 0.5);
    	double y9 = (double)(par3 + 0.4375);
    	double z9 = (double)(par4 + 1);
    	double x10 = (double)(par2 + 0.5);
    	double y10 = (double)(par3 + 0.4375);
    	double z10 = (double)(par4 + 0);
    	double x11 = (double)(par2 + 0.5);
    	double y11 = (double)(par3 + 0.5625);
    	double z11 = (double)(par4 + 1);
    	double x12 = (double)(par2 + 0.5);
    	double y12 = (double)(par3 + 0.5625);
    	double z12 = (double)(par4 + 0);
    ...
    private boolean tentSideLeft_0(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0);
    	double y1 = (double)(par3 + 0);
    	double z1 = (double)(par4 + 0);
    	...
    	double x9 = (double)(par2 + 0.5);
    	double y9 = (double)(par3 + 0.4375);
    	double z9 = (double)(par4 + 0);
    	double x10 = (double)(par2 + 0.5);
    	double y10 = (double)(par3 + 0.4375);
    	double z10 = (double)(par4 + 1);
    	double x11 = (double)(par2 + 0.5);
    	double y11 = (double)(par3 + 0.5625);
    	double z11 = (double)(par4 + 0);
    	double x12 = (double)(par2 + 0.5);
    	double y12 = (double)(par3 + 0.5625);
    	double z12 = (double)(par4 + 1);
    ...
    private boolean tentWall_0(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 1);
    	double y1 = (double)(par3 + 0);
    	double z1 = (double)(par4 + 0.4375);
    	double x2 = (double)(par2 + 1);
    	double y2 = (double)(par3 + 0);
    	double z2 = (double)(par4 + 0.5625);
    	double x3 = (double)(par2 + 0);
    	double y3 = (double)(par3 + 0);
    	double z3 = (double)(par4 + 0.5625);
    	double x4 = (double)(par2 + 0);
    	double y4 = (double)(par3 + 0);
    	double z4 = (double)(par4 + 0.4375);
    	double x5 = (double)(par2 + 1);
    	double y5 = (double)(par3 + 1);
    	double z5 = (double)(par4 + 0.4375);
    	double x6 = (double)(par2 + 1);
    	double y6 = (double)(par3 + 1);
    	double z6 = (double)(par4 + 0.5625);
    	double x7 = (double)(par2 + 0);
    	double y7 = (double)(par3 + 1);
    	double z7 = (double)(par4 + 0.5625);
    	double x8 = (double)(par2 + 0);
    	double y8 = (double)(par3 + 1);
    	double z8 = (double)(par4 + 0.4375);
    ...
    private boolean tentCornerRightFront_0(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0);
    	double y1 = (double)(par3 + 0);
    	double z1 = (double)(par4 + 0);
    	...
    	double x11 = (double)(par2 + 0.5);
    	double y11 = (double)(par3 + 0.5625);
    	double z11 = (double)(par4 + 0.5625);
    	double x12 = (double)(par2 + 0);
    	double y12 = (double)(par3 + 0);
    	double z12 = (double)(par4 + 0.4375);
    	double x13 = (double)(par2 + 0);
    	double y13 = (double)(par3 + 0.125);
    	double z13 = (double)(par4 + 0.4375);
    	double x14 = (double)(par2 + 1);
    	double y14 = (double)(par3 + 1);
    	double z14 = (double)(par4 + 0.4375);
    	double x15 = (double)(par2 + 0.5);
    	double y15 = (double)(par3 + 0.4375);
    	double z15 = (double)(par4 + 0.4375);
    	double x16 = (double)(par2 + 1);
    	double y16 = (double)(par3 + 0);
    	double z16 = (double)(par4 + 0.4375);
    	double x17 = (double)(par2 + 1);
    	double y17 = (double)(par3 + 0.875);
    	double z17 = (double)(par4 + 0.4375);
    ...
    private boolean tentCornerRightBack_0(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0);
    	double y1 = (double)(par3 + 0);
    	double z1 = (double)(par4 + 1);
    	...
    	double x11 = (double)(par2 + 0.5);
    	double y11 = (double)(par3 + 0.5625);
    	double z11 = (double)(par4 + 0.4375);
    	double x12 = (double)(par2 + 0);
    	double y12 = (double)(par3 + 0);
    	double z12 = (double)(par4 + 0.5625);
    	double x13 = (double)(par2 + 0);
    	double y13 = (double)(par3 + 0.125);
    	double z13 = (double)(par4 + 0.5625);
    	double x14 = (double)(par2 + 1);
    	double y14 = (double)(par3 + 1);
    	double z14 = (double)(par4 + 0.5625);
    	double x15 = (double)(par2 + 0.5);
    	double y15 = (double)(par3 + 0.4375);
    	double z15 = (double)(par4 + 0.5625);
    	double x16 = (double)(par2 + 1);
    	double y16 = (double)(par3 + 0);
    	double z16 = (double)(par4 + 0.5625);
    	double x17 = (double)(par2 + 1);
    	double y17 = (double)(par3 + 0.875);
    	double z17 = (double)(par4 + 0.5625);
    ...
    private boolean tentCornerLeftFront_0(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 1);
    	double y1 = (double)(par3 + 0);
    	double z1 = (double)(par4 + 0);
    ...
    private boolean tentCornerLeftBack_0(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 1);
    	double y1 = (double)(par3 + 0);
    	double z1 = (double)(par4 + 1);
    ...
    private boolean tentCapFront_0(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0);
    	double y1 = (double)(par3 + 0);
    	double z1 = (double)(par4 + 0.4375);
    ...
    private boolean tentCapCenter_0(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0);
    	double y1 = (double)(par3 + 0);
    	double z1 = (double)(par4 + 0);
    ...
    private boolean tentCapBack_0(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 1);
    	double y1 = (double)(par3 + 0);
    	double z1 = (double)(par4 + 0.5625);
    	double x2 = (double)(par2 + 0);
    	double y2 = (double)(par3 + 0);
    	double z2 = (double)(par4 + 0.5625);
    	double x3 = (double)(par2 + 0);
    ...
    public boolean renderBlockTentDoor(BlockTentDoor par1Block, int par2, int par3, int par4)
    {
    	int l = this.blockAccess.getBlockMetadata(par2, par3, par4);
        Tessellator tessellator = Tessellator.instance;
        tessellator.setBrightness(par1Block.getMixedBrightnessForBlock(this.blockAccess, par2, par3, par4));
        ...
        Icon icon = par1Block.getBlockTexture(this.blockAccess, par2, par3, par4, 0);
        Icon icon1 = par1Block.getBlockTexture(this.blockAccess, par2, par3, par4, 1);
        
        int meta = this.blockAccess.getBlockMetadata(par2, par3, par4);
        
        switch(meta)
        {
	        // West Closed Facing Code - Lower
	    	case 0:
	        	return tentDoorWestClosed(tessellator, par2, par3, par4, icon);
	        
	    	// South Closed Facing Code - Lower
	    	case 1:
	        	return tentDoorSouthClosed(tessellator, par2, par3, par4, icon);
	        
	        // East Closed Facing Code - Lower
	    	case 2:
	        	return tentDoorEastClosed(tessellator, par2, par3, par4, icon);
	        
	        // East Closed Facing Code - Lower
	    	case 3:
	        	return tentDoorNorthClosed(tessellator, par2, par3, par4, icon);
	        
	        // West Open Facing Code - Lower
	    	case 4:
	        	return tentDoorWestOpen(tessellator, par2, par3, par4, icon);
	        
	    	// South Open Facing Code - Lower
	    	case 5:
	        	return tentDoorSouthOpen(tessellator, par2, par3, par4, icon);
	        
	        // East Open Facing Code - Lower
	    	case 6:
	        	return tentDoorEastOpen(tessellator, par2, par3, par4, icon);
	        
	        // North Open Facing Code - Lower
	    	case 7:
	        	return tentDoorNorthOpen(tessellator, par2, par3, par4, icon);
	        
	        case 8:
	        {
	        	int lowerMeta = this.blockAccess.getBlockMetadata(par2, par3 - 1, par4);
	        	switch(lowerMeta)
	        	{
	        		// West Closed Facing Code - Upper
			    	case 0:
			        	return tentDoorWestClosedTop(tessellator, par2, par3, par4, icon1);
			        
			    	// South Closed Facing Code - Upper
			    	case 1:
			        	return tentDoorSouthClosedTop(tessellator, par2, par3, par4, icon1);
			        
			        // East Closed Facing Code - Upper
			    	case 2:
			        	return tentDoorEastClosedTop(tessellator, par2, par3, par4, icon1);
			        
			        // East Closed Facing Code - Upper
			    	case 3:
			        	return tentDoorNorthClosedTop(tessellator, par2, par3, par4, icon1);
			        
			        // West Open Facing Code - Upper
			    	case 4:
			        	return tentDoorWestOpenTop(tessellator, par2, par3, par4, icon1);
			        
			    	// South Open Facing Code - Upper
			    	case 5:
			        	return tentDoorSouthOpenTop(tessellator, par2, par3, par4, icon1);
			        
			        // East Open Facing Code - Upper
			    	case 6:
			        	return tentDoorEastOpenTop(tessellator, par2, par3, par4, icon1);
			        
			        // North Open Facing Code - Upper
			    	case 7:
			        	return tentDoorNorthOpenTop(tessellator, par2, par3, par4, icon1);
	        	}
	        }
        }
    ...
    private boolean tentDoorWestClosed(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0);
    	double y1 = (double)(par3 + 0.75);
    	double z1 = (double)(par4 + 0.9375);
    	double x2 = (double)(par2 + 0);
    	double y2 = (double)(par3 + 0);
    	double z2 = (double)(par4 + 0);
    	double x3 = (double)(par2 + 0.1875);
    	double y3 = (double)(par3 + 0);
    	double z3 = (double)(par4 + 0);
    	double x4 = (double)(par2 + 0.1875);
    	double y4 = (double)(par3 + 0.75);
    	double z4 = (double)(par4 + 0.9375);
    	double x5 = (double)(par2 + 0);
    	double y5 = (double)(par3 + 1);
    	double z5 = (double)(par4 + 0.9375);
    	double x6 = (double)(par2 + 0);
    	double y6 = (double)(par3 + 1);
    	double z6 = (double)(par4 + 0);
    	double x7 = (double)(par2 + 0.1875);
    	double y7 = (double)(par3 + 1);
    	double z7 = (double)(par4 + 0);
    	double x8 = (double)(par2 + 0.1875);
    	double y8 = (double)(par3 + 1);
    	double z8 = (double)(par4 + 0.9375);
    	double x9 = (double)(par2 + 0);
    	double y9 = (double)(par3 + 0.75);
    	double z9 = (double)(par4 + 0.875);
    	double x10 = (double)(par2 + 0.1875);
    	double y10 = (double)(par3 + 0.75);
    	double z10 = (double)(par4 + 0.875);
    	double x11 = (double)(par2 + 0);
    	double y11 = (double)(par3 + 0.3125);
    	double z11 = (double)(par4 + 0.875);
    	double x12 = (double)(par2 + 0.1875);
    	double y12 = (double)(par3 + 0.3125);
    	double z12 = (double)(par4 + 0.875);
    	double x13 = (double)(par2 + 0);
    	double y13 = (double)(par3 + 0.3125);
    	double z13 = (double)(par4 + 0.8125);
    	double x14 = (double)(par2 + 0.1875);
    	double y14 = (double)(par3 + 0.3125);
    	double z14 = (double)(par4 + 0.8125);
    	double x15 = (double)(par2 + 0);
    	double y15 = (double)(par3 + 0.0625);
    	double z15 = (double)(par4 + 0.8125);
    	double x16 = (double)(par2 + 0.1875);
    	double y16 = (double)(par3 + 0.0625);
    	double z16 = (double)(par4 + 0.8125);
    	double x17 = (double)(par2 + 0);
    	double y17 = (double)(par3 + 0.0625);
    	double z17 = (double)(par4 + 0.75);
    	double x18 = (double)(par2 + 0.1875);
    	double y18 = (double)(par3 + 0.0625);
    	double z18 = (double)(par4 + 0.75);
    	double x19 = (double)(par2 + 0);
    	double y19 = (double)(par3 + 0);
    	double z19 = (double)(par4 + 0.75);
    	double x20 = (double)(par2 + 0.1875);
    	double y20 = (double)(par3 + 0);
    	double z20 = (double)(par4 + 0.75);
    	double x21 = (double)(par2 + 0);
    	double y21 = (double)(par3 + 0.0625);
    	double z21 = (double)(par4 + 0);
    	double x22 = (double)(par2 + 0.1875);
    	double y22 = (double)(par3 + 0.0625);
    	double z22 = (double)(par4 + 0);
    	double x23 = (double)(par2 + 0);
    	double y23 = (double)(par3 + 0.3125);
    	double z23 = (double)(par4 + 0);
    	double x24 = (double)(par2 + 0.1875);
    	double y24 = (double)(par3 + 0.3125);
    	double z24 = (double)(par4 + 0);
    	double x25 = (double)(par2 + 0);
    	double y25 = (double)(par3 + 0.75);
    	double z25 = (double)(par4 + 0);
    	double x26 = (double)(par2 + 0.1875);
    	double y26 = (double)(par3 + 0.75);
    	double z26 = (double)(par4 + 0);

    	double u1 = (double)icon.getInterpolatedU(14D);
    	double v1 = (double)icon.getInterpolatedV(11D);
    	double u2 = (double)icon.getMinU();
    	double v2 = (double)icon.getInterpolatedV(11D);
    	double u3 = (double)icon.getMinU();
    	double v3 = (double)icon.getInterpolatedV(4D);
    	double u4 = (double)icon.getInterpolatedU(14D);
    	double v4 = (double)icon.getInterpolatedV(4D);
    	...
    	double v14 = (double)icon.getInterpolatedV(14D);
    	double u15 = (double)icon.getInterpolatedU(3D);
    	double v15 = (double)icon.getInterpolatedV(15D);
    	double u16 = (double)icon.getMinU();
    	double v16 = (double)icon.getInterpolatedV(15D);
    	double u17 = (double)icon.getMinU();
    	double v17 = (double)icon.getInterpolatedV(5D);
    	double u18 = (double)icon.getInterpolatedU(3D);
    	double v18 = (double)icon.getInterpolatedV(5D);
    	double u19 = (double)icon.getMinU();
    	double v19 = (double)icon.getInterpolatedV(13D);
    	double u20 = (double)icon.getInterpolatedU(3D);
    	double v20 = (double)icon.getInterpolatedV(13D);
    	...
    	double v22 = (double)icon.getInterpolatedV(12D);
    	double u23 = (double)icon.getInterpolatedU(3D);
    	double v23 = (double)icon.getMinV();
    	double u24 = (double)icon.getInterpolatedU(3D);
    	double v24 = (double)icon.getInterpolatedV(5D);
    	double u25 = (double)icon.getInterpolatedU(15D);
    	double v25 = (double)icon.getInterpolatedV(4D);
    	double u26 = (double)icon.getInterpolatedU(15D);
    	double v26 = (double)icon.getMinV();
    	double u27 = (double)icon.getInterpolatedU(13D);
    	double v27 = (double)icon.getInterpolatedV(11D);
    	double u28 = (double)icon.getInterpolatedU(13D);
    	double v28 = (double)icon.getInterpolatedV(15D);
    	double u29 = (double)icon.getInterpolatedU(12D);
    	double v29 = (double)icon.getInterpolatedV(15D);
    	double u30 = (double)icon.getInterpolatedU(12D);
    	...
    	tessellator.addVertexWithUV(x1, y1, z1, u14, v14);
    	tessellator.addVertexWithUV(x9, y9, z9, u15, v15);
    	tessellator.addVertexWithUV(x10, y10, z10, u16, v16);
    	tessellator.addVertexWithUV(x11, y11, z11, u17, v17);
    	tessellator.addVertexWithUV(x12, y12, z12, u18, v18);
    	tessellator.addVertexWithUV(x10, y10, z10, u11, v11);
    	tessellator.addVertexWithUV(x9, y9, z9, u10, v10);
    	tessellator.addVertexWithUV(x13, y13, z13, u14, v14);
    	tessellator.addVertexWithUV(x14, y14, z14, u13, v13);
    	tessellator.addVertexWithUV(x12, y12, z12, u19, v19);
    	tessellator.addVertexWithUV(x11, y11, z11, u20, v20);
    	tessellator.addVertexWithUV(x15, y15, z15, u6, v6);
    	tessellator.addVertexWithUV(x16, y16, z16, u21, v21);
    	tessellator.addVertexWithUV(x14, y14, z14, u18, v18);
    	tessellator.addVertexWithUV(x13, y13, z13, u17, v17);
    	tessellator.addVertexWithUV(x17, y17, z17, u20, v20);
    	tessellator.addVertexWithUV(x18, y18, z18, u19, v19);
    	tessellator.addVertexWithUV(x16, y16, z16, u10, v10);
    	tessellator.addVertexWithUV(x15, y15, z15, u22, v22);
    	tessellator.addVertexWithUV(x19, y19, z19, u7, v7);
    	tessellator.addVertexWithUV(x20, y20, z20, u23, v23);
    	tessellator.addVertexWithUV(x18, y18, z18, u5, v5);
    	tessellator.addVertexWithUV(x17, y17, z17, u6, v6);
    	tessellator.addVertexWithUV(x19, y19, z19, u8, v8);
    	tessellator.addVertexWithUV(x2, y2, z2, u22, v22);
    	tessellator.addVertexWithUV(x3, y3, z3, u10, v10);
    	tessellator.addVertexWithUV(x20, y20, z20, u7, v7);
    	tessellator.addVertexWithUV(x23, y23, z23, u24, v24);
    	tessellator.addVertexWithUV(x24, y24, z24, u17, v17);
    	tessellator.addVertexWithUV(x22, y22, z22, u6, v6);
    	tessellator.addVertexWithUV(x21, y21, z21, u5, v5);
    	tessellator.addVertexWithUV(x25, y25, z25, u22, v22);
    	tessellator.addVertexWithUV(x26, y26, z26, u10, v10);
    	tessellator.addVertexWithUV(x24, y24, z24, u17, v17);
    	tessellator.addVertexWithUV(x23, y23, z23, u24, v24);
    	tessellator.addVertexWithUV(x25, y25, z25, u22, v22);
    	tessellator.addVertexWithUV(x6, y6, z6, u12, v12);
    	tessellator.addVertexWithUV(x7, y7, z7, u9, v9);
    	tessellator.addVertexWithUV(x26, y26, z26, u10, v10);
    	tessellator.addVertexWithUV(x4, y4, z4, u25, v25);
    	tessellator.addVertexWithUV(x26, y26, z26, u3, v3);
    	tessellator.addVertexWithUV(x7, y7, z7, u7, v7);
    	tessellator.addVertexWithUV(x8, y8, z8, u26, v26);
    	tessellator.addVertexWithUV(x14, y14, z14, u27, v27);
    	tessellator.addVertexWithUV(x16, y16, z16, u28, v28);
    	tessellator.addVertexWithUV(x22, y22, z22, u16, v16);
    	tessellator.addVertexWithUV(x24, y24, z24, u2, v2);
    	tessellator.addVertexWithUV(x22, y22, z22, u16, v16);
    	tessellator.addVertexWithUV(x18, y18, z18, u29, v29);
    	tessellator.addVertexWithUV(x20, y20, z20, u30, v30);
    	tessellator.addVertexWithUV(x3, y3, z3, u9, v9);
    	tessellator.addVertexWithUV(x6, y6, z6, u8, v8);
    	tessellator.addVertexWithUV(x5, y5, z5, u15, v15);
    	tessellator.addVertexWithUV(x8, y8, z8, u16, v16);
    	tessellator.addVertexWithUV(x7, y7, z7, u7, v7);
    	tessellator.addVertexWithUV(x25, y25, z25, u3, v3);
    	tessellator.addVertexWithUV(x1, y1, z1, u25, v25);
    	tessellator.addVertexWithUV(x5, y5, z5, u26, v26);
    	tessellator.addVertexWithUV(x6, y6, z6, u7, v7);
    	tessellator.addVertexWithUV(x9, y9, z9, u4, v4);
    	tessellator.addVertexWithUV(x25, y25, z25, u3, v3);
    	tessellator.addVertexWithUV(x23, y23, z23, u2, v2);
    	tessellator.addVertexWithUV(x11, y11, z11, u1, v1);
    	tessellator.addVertexWithUV(x13, y13, z13, u27, v27);
    	tessellator.addVertexWithUV(x23, y23, z23, u2, v2);
    	tessellator.addVertexWithUV(x21, y21, z21, u16, v16);
    	tessellator.addVertexWithUV(x15, y15, z15, u28, v28);
    	tessellator.addVertexWithUV(x17, y17, z17, u29, v29);
    	tessellator.addVertexWithUV(x21, y21, z21, u16, v16);
    	tessellator.addVertexWithUV(x2, y2, z2, u9, v9);
    	tessellator.addVertexWithUV(x19, y19, z19, u30, v30);
    	return true;
    }
       
    private boolean tentDoorNorthClosed(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0.9375);
    	double y1 = (double)(par3 + 0.75);
    	double z1 = (double)(par4 + 1);
    	double x2 = (double)(par2 + 0);
    	double y2 = (double)(par3 + 0);
    	...
    	double x3 = (double)(par2 + 0);
    	double y3 = (double)(par3 + 0);
    	double z3 = (double)(par4 + 0.8125);
    	double x4 = (double)(par2 + 0.9375);
    	double y4 = (double)(par3 + 0.75);
    	double z4 = (double)(par4 + 0.8125);
    	double x5 = (double)(par2 + 0.9375);
    	double y5 = (double)(par3 + 1);
    	double z5 = (double)(par4 + 1);
    	double x6 = (double)(par2 + 0);
    	double y6 = (double)(par3 + 1);
    	...
    	double x7 = (double)(par2 + 0);
    	double y7 = (double)(par3 + 1);
    	double z7 = (double)(par4 + 0.8125);
    	double x8 = (double)(par2 + 0.9375);
    	double y8 = (double)(par3 + 1);
    	double z8 = (double)(par4 + 0.8125);
    	double x9 = (double)(par2 + 0.875);
    	double y9 = (double)(par3 + 0.75);
    	double z9 = (double)(par4 + 1);
    	double x10 = (double)(par2 + 0.875);
    	double y10 = (double)(par3 + 0.75);
    	double z10 = (double)(par4 + 0.8125);
    	double x11 = (double)(par2 + 0.875);
    	double y11 = (double)(par3 + 0.3125);
    	double z11 = (double)(par4 + 1);
    	double x12 = (double)(par2 + 0.875);
    	double y12 = (double)(par3 + 0.3125);
    	double z12 = (double)(par4 + 0.8125);
    	double x13 = (double)(par2 + 0.8125);
    	double y13 = (double)(par3 + 0.3125);
    	double z13 = (double)(par4 + 1);
    	double x14 = (double)(par2 + 0.8125);
    	double y14 = (double)(par3 + 0.3125);
    	double z14 = (double)(par4 + 0.8125);
    	double x15 = (double)(par2 + 0.8125);
    	double y15 = (double)(par3 + 0.0625);
    	double z15 = (double)(par4 + 1);
    	double x16 = (double)(par2 + 0.8125);
    	double y16 = (double)(par3 + 0.0625);
    	double z16 = (double)(par4 + 0.8125);
    	double x17 = (double)(par2 + 0.75);
    	double y17 = (double)(par3 + 0.0625);
    	double z17 = (double)(par4 + 1);
    	double x18 = (double)(par2 + 0.75);
    	double y18 = (double)(par3 + 0.0625);
    	double z18 = (double)(par4 + 0.8125);
    	double x19 = (double)(par2 + 0.75);
    	double y19 = (double)(par3 + 0);
    	double z19 = (double)(par4 + 1);
    	double x20 = (double)(par2 + 0.75);
    	double y20 = (double)(par3 + 0);
    	double z20 = (double)(par4 + 0.8125);
    	double x21 = (double)(par2 + 0);
    	double y21 = (double)(par3 + 0.0625);
    	double z21 = (double)(par4 + 1);
    	double x22 = (double)(par2 + 0);
    	double y22 = (double)(par3 + 0.0625);
    	double z22 = (double)(par4 + 0.8125);
    	double x23 = (double)(par2 + 0);
    	double y23 = (double)(par3 + 0.3125);
    	double z23 = (double)(par4 + 1);
    	double x24 = (double)(par2 + 0);
    	double y24 = (double)(par3 + 0.3125);
    	double z24 = (double)(par4 + 0.8125);
    	double x25 = (double)(par2 + 0);
    	double y25 = (double)(par3 + 0.75);
    	double z25 = (double)(par4 + 1);
    	double x26 = (double)(par2 + 0);
    	double y26 = (double)(par3 + 0.75);
    	double z26 = (double)(par4 + 0.8125);
    ...
    private boolean tentDoorEastClosed(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 1);
    	double y1 = (double)(par3 + 0.75);
    	...
    	double y2 = (double)(par3 + 0);
    	double z2 = (double)(par4 + 1);
    	double x3 = (double)(par2 + 0.8125);
    	double y3 = (double)(par3 + 0);
    	double z3 = (double)(par4 + 1);
    	double x4 = (double)(par2 + 0.8125);
    	double y4 = (double)(par3 + 0.75);
    	...
    	double y6 = (double)(par3 + 1);
    	double z6 = (double)(par4 + 1);
    	double x7 = (double)(par2 + 0.8125);
    	double y7 = (double)(par3 + 1);
    	double z7 = (double)(par4 + 1);
    	double x8 = (double)(par2 + 0.8125);
    	double y8 = (double)(par3 + 1);
    	double z8 = (double)(par4 + 0.0625);
    	double x9 = (double)(par2 + 1);
    	double y9 = (double)(par3 + 0.75);
    	double z9 = (double)(par4 + 0.125);
    	double x10 = (double)(par2 + 0.8125);
    	double y10 = (double)(par3 + 0.75);
    	double z10 = (double)(par4 + 0.125);
    	double x11 = (double)(par2 + 1);
    	double y11 = (double)(par3 + 0.3125);
    	double z11 = (double)(par4 + 0.125);
    	double x12 = (double)(par2 + 0.8125);
    	double y12 = (double)(par3 + 0.3125);
    	...
    	double x18 = (double)(par2 + 0.8125);
    	double y18 = (double)(par3 + 0.0625);
    	double z18 = (double)(par4 + 0.25);
    	double x19 = (double)(par2 + 1);
    	double y19 = (double)(par3 + 0);
    	double z19 = (double)(par4 + 0.25);
    	double x20 = (double)(par2 + 0.8125);
    	double y20 = (double)(par3 + 0);
    	double z20 = (double)(par4 + 0.25);
    	double x21 = (double)(par2 + 1);
    	double y21 = (double)(par3 + 0.0625);
    	double z21 = (double)(par4 + 1);
    	double x22 = (double)(par2 + 0.8125);
    	double y22 = (double)(par3 + 0.0625);
    	double z22 = (double)(par4 + 1);
    	double x23 = (double)(par2 + 1);
    	double y23 = (double)(par3 + 0.3125);
    	double z23 = (double)(par4 + 1);
    	double x24 = (double)(par2 + 0.8125);
    	double y24 = (double)(par3 + 0.3125);
    	double z24 = (double)(par4 + 1);
    	double x25 = (double)(par2 + 1);
    	double y25 = (double)(par3 + 0.75);
    	double z25 = (double)(par4 + 1);
    	double x26 = (double)(par2 + 0.8125);
    	double y26 = (double)(par3 + 0.75);
    ...
    private boolean tentDoorSouthClosed(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0.0625);
    	double y1 = (double)(par3 + 0.75);
    	double z1 = (double)(par4 + 0);
    	double x2 = (double)(par2 + 1);
    	double y2 = (double)(par3 + 0);
    	...
    	double x3 = (double)(par2 + 1);
    	double y3 = (double)(par3 + 0);
    	double z3 = (double)(par4 + 0.1875);
    	double x4 = (double)(par2 + 0.0625);
    	double y4 = (double)(par3 + 0.75);
    	double z4 = (double)(par4 + 0.1875);
    	double x5 = (double)(par2 + 0.0625);
    	double y5 = (double)(par3 + 1);
    	double z5 = (double)(par4 + 0);
    	double x6 = (double)(par2 + 1);
    	double y6 = (double)(par3 + 1);
    	...
    	double x7 = (double)(par2 + 1);
    	double y7 = (double)(par3 + 1);
    	double z7 = (double)(par4 + 0.1875);
    	double x8 = (double)(par2 + 0.0625);
    	double y8 = (double)(par3 + 1);
    	double z8 = (double)(par4 + 0.1875);
    	double x9 = (double)(par2 + 0.125);
    	double y9 = (double)(par3 + 0.75);
    	double z9 = (double)(par4 + 0);
    	double x10 = (double)(par2 + 0.125);
    	double y10 = (double)(par3 + 0.75);
    	double z10 = (double)(par4 + 0.1875);
    	double x11 = (double)(par2 + 0.125);
    	double y11 = (double)(par3 + 0.3125);
    	double z11 = (double)(par4 + 0);
    	double x12 = (double)(par2 + 0.125);
    	double y12 = (double)(par3 + 0.3125);
    	double z12 = (double)(par4 + 0.1875);
    	...
    	double y16 = (double)(par3 + 0.0625);
    	double z16 = (double)(par4 + 0.1875);
    	double x17 = (double)(par2 + 0.25);
    	double y17 = (double)(par3 + 0.0625);
    	double z17 = (double)(par4 + 0);
    	double x18 = (double)(par2 + 0.25);
    	double y18 = (double)(par3 + 0.0625);
    	double z18 = (double)(par4 + 0.1875);
    	double x19 = (double)(par2 + 0.25);
    	double y19 = (double)(par3 + 0);
    	double z19 = (double)(par4 + 0);
    	double x20 = (double)(par2 + 0.25);
    	double y20 = (double)(par3 + 0);
    	double z20 = (double)(par4 + 0.1875);
    	double x21 = (double)(par2 + 1);
    	double y21 = (double)(par3 + 0.0625);
    	double z21 = (double)(par4 + 0);
    	double x22 = (double)(par2 + 1);
    	double y22 = (double)(par3 + 0.0625);
    	double z22 = (double)(par4 + 0.1875);
    	double x23 = (double)(par2 + 1);
    	double y23 = (double)(par3 + 0.3125);
    	double z23 = (double)(par4 + 0);
    	double x24 = (double)(par2 + 1);
    	double y24 = (double)(par3 + 0.3125);
    	double z24 = (double)(par4 + 0.1875);
    	double x25 = (double)(par2 + 1);
    	double y25 = (double)(par3 + 0.75);
    	double z25 = (double)(par4 + 0);
    	double x26 = (double)(par2 + 1);
    	double y26 = (double)(par3 + 0.75);
    	double z26 = (double)(par4 + 0.1875);
    ...
    private boolean tentDoorNorthOpen(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    ...
    private boolean tentDoorWestOpen(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0.9375);
    	double y1 = (double)(par3 + 0.75);
    	double z1 = (double)(par4 + 0.1875);
    	double x2 = (double)(par2 + 0);
    	double y2 = (double)(par3 + 0);
    	double z2 = (double)(par4 + 0.1875);
    	double x3 = (double)(par2 + 0);
    	double y3 = (double)(par3 + 0);
    	double z3 = (double)(par4 + 0);
    	double x4 = (double)(par2 + 0.9375);
    	...
    	double x5 = (double)(par2 + 0.9375);
    	double y5 = (double)(par3 + 1);
    	double z5 = (double)(par4 + 0.1875);
    	double x6 = (double)(par2 + 0);
    	double y6 = (double)(par3 + 1);
    	double z6 = (double)(par4 + 0.1875);
    	double x7 = (double)(par2 + 0);
    	double y7 = (double)(par3 + 1);
    	double z7 = (double)(par4 + 0);
    	double x8 = (double)(par2 + 0.9375);
    	...
    	double x9 = (double)(par2 + 0.875);
    	double y9 = (double)(par3 + 0.75);
    	double z9 = (double)(par4 + 0.1875);
    	double x10 = (double)(par2 + 0.875);
    	double y10 = (double)(par3 + 0.75);
    	double z10 = (double)(par4 + 0);
    	double x11 = (double)(par2 + 0.875);
    	double y11 = (double)(par3 + 0.3125);
    	double z11 = (double)(par4 + 0.1875);
    	double x12 = (double)(par2 + 0.875);
    	double y12 = (double)(par3 + 0.3125);
    	double z12 = (double)(par4 + 0);
    	double x13 = (double)(par2 + 0.8125);
    	...
    	double x17 = (double)(par2 + 0.75);
    	double y17 = (double)(par3 + 0.0625);
    	double z17 = (double)(par4 + 0.1875);
    	double x18 = (double)(par2 + 0.75);
    	double y18 = (double)(par3 + 0.0625);
    	double z18 = (double)(par4 + 0);
    	double x19 = (double)(par2 + 0.75);
    	double y19 = (double)(par3 + 0);
    	double z19 = (double)(par4 + 0.1875);
    	double x20 = (double)(par2 + 0.75);
    	double y20 = (double)(par3 + 0);
    	double z20 = (double)(par4 + 0);
    	double x21 = (double)(par2 + 0);
    	double y21 = (double)(par3 + 0.0625);
    	double z21 = (double)(par4 + 0.1875);
    	double x22 = (double)(par2 + 0);
    	double y22 = (double)(par3 + 0.0625);
    	double z22 = (double)(par4 + 0);
    	double x23 = (double)(par2 + 0);
    	double y23 = (double)(par3 + 0.3125);
    	double z23 = (double)(par4 + 0.1875);
    	double x24 = (double)(par2 + 0);
    	double y24 = (double)(par3 + 0.3125);
    	double z24 = (double)(par4 + 0);
    	double x25 = (double)(par2 + 0);
    	double y25 = (double)(par3 + 0.75);
    	double z25 = (double)(par4 + 0.1875);
    	double x26 = (double)(par2 + 0);
    	double y26 = (double)(par3 + 0.75);
    	double z26 = (double)(par4 + 0);
    ...
    private boolean tentDoorSouthOpen(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0.8125);
    	double y1 = (double)(par3 + 0.75);
    	double z1 = (double)(par4 + 0.9375);
    	double x2 = (double)(par2 + 0.8125);
    	double y2 = (double)(par3 + 0);
    	double z2 = (double)(par4 + 0);
    	double x3 = (double)(par2 + 1);
    	double y3 = (double)(par3 + 0);
    	...
    	double y4 = (double)(par3 + 0.75);
    	double z4 = (double)(par4 + 0.9375);
    	double x5 = (double)(par2 + 0.8125);
    	double y5 = (double)(par3 + 1);
    	double z5 = (double)(par4 + 0.9375);
    	double x6 = (double)(par2 + 0.8125);
    	double y6 = (double)(par3 + 1);
    	double z6 = (double)(par4 + 0);
    	double x7 = (double)(par2 + 1);
    	double y7 = (double)(par3 + 1);
    	...
    	double y8 = (double)(par3 + 1);
    	double z8 = (double)(par4 + 0.9375);
    	double x9 = (double)(par2 + 0.8125);
    	double y9 = (double)(par3 + 0.75);
    	double z9 = (double)(par4 + 0.875);
    	double x10 = (double)(par2 + 1);
    	double y10 = (double)(par3 + 0.75);
    	double z10 = (double)(par4 + 0.875);
    	double x11 = (double)(par2 + 0.8125);
    	double y11 = (double)(par3 + 0.3125);
    	double z11 = (double)(par4 + 0.875);
    	double x12 = (double)(par2 + 1);
    	double y12 = (double)(par3 + 0.3125);
    	...
    	double y16 = (double)(par3 + 0.0625);
    	double z16 = (double)(par4 + 0.8125);
    	double x17 = (double)(par2 + 0.8125);
    	double y17 = (double)(par3 + 0.0625);
    	double z17 = (double)(par4 + 0.75);
    	double x18 = (double)(par2 + 1);
    	double y18 = (double)(par3 + 0.0625);
    	double z18 = (double)(par4 + 0.75);
    	double x19 = (double)(par2 + 0.8125);
    	double y19 = (double)(par3 + 0);
    	double z19 = (double)(par4 + 0.75);
    	double x20 = (double)(par2 + 1);
    	double y20 = (double)(par3 + 0);
    	double z20 = (double)(par4 + 0.75);
    	double x21 = (double)(par2 + 0.8125);
    	double y21 = (double)(par3 + 0.0625);
    	double z21 = (double)(par4 + 0);
    	double x22 = (double)(par2 + 1);
    	double y22 = (double)(par3 + 0.0625);
    	double z22 = (double)(par4 + 0);
    	double x23 = (double)(par2 + 0.8125);
    	double y23 = (double)(par3 + 0.3125);
    	double z23 = (double)(par4 + 0);
    	double x24 = (double)(par2 + 1);
    	double y24 = (double)(par3 + 0.3125);
    	double z24 = (double)(par4 + 0);
    	double x25 = (double)(par2 + 0.8125);
    	double y25 = (double)(par3 + 0.75);
    	double z25 = (double)(par4 + 0);
    	double x26 = (double)(par2 + 1);
    	double y26 = (double)(par3 + 0.75);
    ...
    private boolean tentDoorEastOpen(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0.0625);
    	double y1 = (double)(par3 + 0.75);
    	double z1 = (double)(par4 + 0.8125);
    	double x2 = (double)(par2 + 1);
    	double y2 = (double)(par3 + 0);
    	double z2 = (double)(par4 + 0.8125);
    	double x3 = (double)(par2 + 1);
    	double y3 = (double)(par3 + 0);
    	double z3 = (double)(par4 + 1);
    	double x4 = (double)(par2 + 0.0625);
    	...
    	double x5 = (double)(par2 + 0.0625);
    	double y5 = (double)(par3 + 1);
    	double z5 = (double)(par4 + 0.8125);
    	double x6 = (double)(par2 + 1);
    	double y6 = (double)(par3 + 1);
    	double z6 = (double)(par4 + 0.8125);
    	double x7 = (double)(par2 + 1);
    	double y7 = (double)(par3 + 1);
    	double z7 = (double)(par4 + 1);
    	double x8 = (double)(par2 + 0.0625);
    	...
    	double x9 = (double)(par2 + 0.125);
    	double y9 = (double)(par3 + 0.75);
    	double z9 = (double)(par4 + 0.8125);
    	double x10 = (double)(par2 + 0.125);
    	double y10 = (double)(par3 + 0.75);
    	double z10 = (double)(par4 + 1);
    	double x11 = (double)(par2 + 0.125);
    	double y11 = (double)(par3 + 0.3125);
    	double z11 = (double)(par4 + 0.8125);
    	double x12 = (double)(par2 + 0.125);
    	double y12 = (double)(par3 + 0.3125);
    	double z12 = (double)(par4 + 1);
    	double x13 = (double)(par2 + 0.1875);
    	...
    	double x17 = (double)(par2 + 0.25);
    	double y17 = (double)(par3 + 0.0625);
    	double z17 = (double)(par4 + 0.8125);
    	double x18 = (double)(par2 + 0.25);
    	double y18 = (double)(par3 + 0.0625);
    	double z18 = (double)(par4 + 1);
    	double x19 = (double)(par2 + 0.25);
    	double y19 = (double)(par3 + 0);
    	double z19 = (double)(par4 + 0.8125);
    	double x20 = (double)(par2 + 0.25);
    	double y20 = (double)(par3 + 0);
    	double z20 = (double)(par4 + 1);
    	double x21 = (double)(par2 + 1);
    	double y21 = (double)(par3 + 0.0625);
    	double z21 = (double)(par4 + 0.8125);
    	double x22 = (double)(par2 + 1);
    	double y22 = (double)(par3 + 0.0625);
    	double z22 = (double)(par4 + 1);
    	double x23 = (double)(par2 + 1);
    	double y23 = (double)(par3 + 0.3125);
    	double z23 = (double)(par4 + 0.8125);
    	double x24 = (double)(par2 + 1);
    	double y24 = (double)(par3 + 0.3125);
    	double z24 = (double)(par4 + 1);
    	double x25 = (double)(par2 + 1);
    	double y25 = (double)(par3 + 0.75);
    	double z25 = (double)(par4 + 0.8125);
    	double x26 = (double)(par2 + 1);
    	double y26 = (double)(par3 + 0.75);
    	double z26 = (double)(par4 + 1);
    ...
    private boolean tentDoorEastClosedTop(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 1);
    	double y1 = (double)(par3 + 0.3125);
    	double z1 = (double)(par4 + 0);
    	double x2 = (double)(par2 + 0.8125);
    	double y2 = (double)(par3 + 0.3125);
    	double z2 = (double)(par4 + 0);
    	double x3 = (double)(par2 + 1);
    	double y3 = (double)(par3 + 1);
    	double z3 = (double)(par4 + 0);
    	double x4 = (double)(par2 + 1);
    	double y4 = (double)(par3 + 1);
    	double z4 = (double)(par4 + 1);
    	double x5 = (double)(par2 + 0.8125);
    	double y5 = (double)(par3 + 1);
    	double z5 = (double)(par4 + 1);
    	...
    	double z6 = (double)(par4 + 0);
    	double x7 = (double)(par2 + 0.8125);
    	double y7 = (double)(par3 + 0.3125);
    	double z7 = (double)(par4 + 1);
    	double x8 = (double)(par2 + 1);
    	double y8 = (double)(par3 + 0.3125);
    	double z8 = (double)(par4 + 1);
    	double x9 = (double)(par2 + 1);
    	double y9 = (double)(par3 + 0);
    	double z9 = (double)(par4 + 1);
    	double x10 = (double)(par2 + 0.8125);
    	double y10 = (double)(par3 + 0);
    	double z10 = (double)(par4 + 1);
    	double x11 = (double)(par2 + 1);
    	double y11 = (double)(par3 + 0.3125);
    	double z11 = (double)(par4 + 0.0625);
    	double x12 = (double)(par2 + 0.8125);
    	double y12 = (double)(par3 + 0.3125);
    	double z12 = (double)(par4 + 0.0625);
    	double x13 = (double)(par2 + 1);
    	double y13 = (double)(par3 + 0);
    	double z13 = (double)(par4 + 0.0625);
    	double x14 = (double)(par2 + 0.8125);
    	double y14 = (double)(par3 + 0);
    	double z14 = (double)(par4 + 0.0625);

    	double u1 = (double)icon.getMinU();
    	double v1 = (double)icon.getMaxV();
    	double u2 = (double)icon.getMinU();
    	double v2 = (double)icon.getInterpolatedV(5D);
    	double u3 = (double)icon.getInterpolatedU(3D);
    	double v3 = (double)icon.getInterpolatedV(5D);
    	double u4 = (double)icon.getInterpolatedU(3D);
    	double v4 = (double)icon.getMaxV();
    	double u5 = (double)icon.getMinU();
    	double v5 = (double)icon.getInterpolatedV(3D);
    	double u6 = (double)icon.getMinU();
    	double v6 = (double)icon.getMinV();
    	double u7 = (double)icon.getInterpolatedU(15D);
    	double v7 = (double)icon.getMinV();
    	double u8 = (double)icon.getInterpolatedU(15D);
    	double v8 = (double)icon.getInterpolatedV(3D);
    	double u9 = (double)icon.getInterpolatedU(3D);
    	double v9 = (double)icon.getMinV();
    	double u10 = (double)icon.getMaxU();
    	double v10 = (double)icon.getMinV();
    	double u11 = (double)icon.getMaxU();
    	double v11 = (double)icon.getInterpolatedV(3D);
    	double u12 = (double)icon.getMinU();
    	double v12 = (double)icon.getInterpolatedV(3D);
    	double u13 = (double)icon.getInterpolatedU(15D);
    	double v13 = (double)icon.getMaxV();
    	double u14 = (double)icon.getMinU();
    	double v14 = (double)icon.getInterpolatedV(11D);
    	double u15 = (double)icon.getInterpolatedU(15D);
    	double v15 = (double)icon.getInterpolatedV(11D);
    	double u16 = (double)icon.getInterpolatedU(15D);
    	double v16 = (double)icon.getMaxV();
    	double u17 = (double)icon.getMaxU();
    	double v17 = (double)icon.getInterpolatedV(11D);
    	double u18 = (double)icon.getMaxU();
    	double v18 = (double)icon.getInterpolatedV(11D);
    	double u19 = (double)icon.getMaxU();
    	double v19 = (double)icon.getMinV();

    	tessellator.addVertexWithUV(x3, y3, z3, u1, v1);
    	tessellator.addVertexWithUV(x1, y1, z1, u2, v2);
    	tessellator.addVertexWithUV(x2, y2, z2, u3, v3);
    	tessellator.addVertexWithUV(x6, y6, z6, u4, v4);
    	tessellator.addVertexWithUV(x9, y9, z9, u5, v5);
    	tessellator.addVertexWithUV(x10, y10, z10, u6, v6);
    	tessellator.addVertexWithUV(x14, y14, z14, u7, v7);
    	tessellator.addVertexWithUV(x13, y13, z13, u8, v8);
    	tessellator.addVertexWithUV(x8, y8, z8, u3, v3);
    	tessellator.addVertexWithUV(x7, y7, z7, u2, v2);
    	tessellator.addVertexWithUV(x10, y10, z10, u6, v6);
    	tessellator.addVertexWithUV(x9, y9, z9, u9, v9);
    	tessellator.addVertexWithUV(x4, y4, z4, u6, v6);
    	tessellator.addVertexWithUV(x3, y3, z3, u10, v10);
    	tessellator.addVertexWithUV(x6, y6, z6, u11, v11);
    	tessellator.addVertexWithUV(x5, y5, z5, u12, v12);
    	tessellator.addVertexWithUV(x2, y2, z2, u8, v8);
    	tessellator.addVertexWithUV(x1, y1, z1, u7, v7);
    	tessellator.addVertexWithUV(x11, y11, z11, u10, v10);
    	tessellator.addVertexWithUV(x12, y12, z12, u11, v11);
    	tessellator.addVertexWithUV(x13, y13, z13, u6, v6);
    	tessellator.addVertexWithUV(x14, y14, z14, u9, v9);
    	tessellator.addVertexWithUV(x12, y12, z12, u3, v3);
    	tessellator.addVertexWithUV(x11, y11, z11, u2, v2);
    	tessellator.addVertexWithUV(x4, y4, z4, u4, v4);
    	tessellator.addVertexWithUV(x5, y5, z5, u1, v1);
    	tessellator.addVertexWithUV(x7, y7, z7, u2, v2);
    	tessellator.addVertexWithUV(x8, y8, z8, u3, v3);
    	tessellator.addVertexWithUV(x9, y9, z9, u13, v13);
    	tessellator.addVertexWithUV(x13, y13, z13, u1, v1);
    	tessellator.addVertexWithUV(x11, y11, z11, u14, v14);
    	tessellator.addVertexWithUV(x8, y8, z8, u15, v15);
    	tessellator.addVertexWithUV(x10, y10, z10, u1, v1);
    	tessellator.addVertexWithUV(x7, y7, z7, u14, v14);
    	tessellator.addVertexWithUV(x12, y12, z12, u15, v15);
    	tessellator.addVertexWithUV(x14, y14, z14, u16, v16);
    	tessellator.addVertexWithUV(x8, y8, z8, u17, v17);
    	tessellator.addVertexWithUV(x1, y1, z1, u14, v14);
    	tessellator.addVertexWithUV(x3, y3, z3, u6, v6);
    	tessellator.addVertexWithUV(x4, y4, z4, u10, v10);
    	tessellator.addVertexWithUV(x2, y2, z2, u18, v18);
    	tessellator.addVertexWithUV(x7, y7, z7, u14, v14);
    	tessellator.addVertexWithUV(x5, y5, z5, u6, v6);
    	tessellator.addVertexWithUV(x6, y6, z6, u19, v19);
    	return true;
    }
   
    private boolean tentDoorSouthClosedTop(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0);
    	double y1 = (double)(par3 + 0.3125);
    	double z1 = (double)(par4 + 0);
    	...
    	double y10 = (double)(par3 + 0);
    	double z10 = (double)(par4 + 0.1875);
    	double x11 = (double)(par2 + 0.0625);
    	double y11 = (double)(par3 + 0.3125);
    	double z11 = (double)(par4 + 0);
    	double x12 = (double)(par2 + 0.0625);
    	double y12 = (double)(par3 + 0.3125);
    	double z12 = (double)(par4 + 0.1875);
    	double x13 = (double)(par2 + 0.0625);
    	double y13 = (double)(par3 + 0);
    	double z13 = (double)(par4 + 0);
    	double x14 = (double)(par2 + 0.0625);
    	double y14 = (double)(par3 + 0);
    	double z14 = (double)(par4 + 0.1875);
    ...
    private boolean tentDoorNorthClosedTop(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 1);
    	double y1 = (double)(par3 + 0.3125);
    	double z1 = (double)(par4 + 1);
    	...
    	double y10 = (double)(par3 + 0);
    	double z10 = (double)(par4 + 0.8125);
    	double x11 = (double)(par2 + 0.9375);
    	double y11 = (double)(par3 + 0.3125);
    	double z11 = (double)(par4 + 1);
    	double x12 = (double)(par2 + 0.9375);
    	double y12 = (double)(par3 + 0.3125);
    	double z12 = (double)(par4 + 0.8125);
    	double x13 = (double)(par2 + 0.9375);
    	double y13 = (double)(par3 + 0);
    	double z13 = (double)(par4 + 1);
    	double x14 = (double)(par2 + 0.9375);
    	double y14 = (double)(par3 + 0);
    	double z14 = (double)(par4 + 0.8125);
    ...
    private boolean tentDoorWestClosedTop(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0);
    	double y1 = (double)(par3 + 0.3125);
    	double z1 = (double)(par4 + 1);
    	...
    	double x11 = (double)(par2 + 0);
    	double y11 = (double)(par3 + 0.3125);
    	double z11 = (double)(par4 + 0.9375);
    	double x12 = (double)(par2 + 0.1875);
    	double y12 = (double)(par3 + 0.3125);
    	double z12 = (double)(par4 + 0.9375);
    	double x13 = (double)(par2 + 0);
    	double y13 = (double)(par3 + 0);
    	double z13 = (double)(par4 + 0.9375);
    	double x14 = (double)(par2 + 0.1875);
    	double y14 = (double)(par3 + 0);
    	double z14 = (double)(par4 + 0.9375);
    ...
    private boolean tentDoorEastOpenTop(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0);
    	double y1 = (double)(par3 + 0.3125);
    	double z1 = (double)(par4 + 0.8125);
    ...
    private boolean tentDoorWestOpenTop(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 1);
    	double y1 = (double)(par3 + 0.3125);
    	double z1 = (double)(par4 + 0.1875);
    ...
    private boolean tentDoorNorthOpenTop(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0.1875);
    	double y1 = (double)(par3 + 0.3125);
    	double z1 = (double)(par4 + 0);
    ...
    private boolean tentDoorSouthOpenTop(Tessellator tessellator, double par2, double par3, double par4, Icon icon)
    {
    	double x1 = (double)(par2 + 0.8125);
    	double y1 = (double)(par3 + 0.3125);
    	double z1 = (double)(par4 + 1);
