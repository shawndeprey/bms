...
public class BlockFlax extends Block implements IPlantable, IShearable
{
    protected BlockFlax(int par1, Material par2Material)
    {
    ...
    public void harvestBlock(World par1World, EntityPlayer par2EntityPlayer, int par3, int par4, int par5, int par6)
    {
    	...
    	if(par2EntityPlayer.getHeldItem().itemID != Item.shears.itemID){
    		super.harvestBlock(par1World, par2EntityPlayer, par3, par4, par5, par6);
    	}
    }
    ...
    public ArrayList<ItemStack> onSheared(ItemStack item, World world, int x, int y, int z, int fortune)
    {
        ...
        ret.add(new ItemStack(ItemsBMS.flaxFiber));
        return ret;
    }
}
