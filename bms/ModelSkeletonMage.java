...
public class ModelSkeletonMage extends ModelZombie
{
    ...
    public ModelSkeletonMage(float par1)
    {
    ...
    {
        this.aimedBow = ((EntitySkeletonMage)par1EntityLivingBase).getSkeletonType() == 1;
